    ...
    <div v-if="show('household_members') || show('family_members_count')" class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
      ...
      <div class="p-4">
            ...
            <div class="pl-4 pr-3 pt-3 pb-3">
              ...
              <div class="flex items-start gap-2">
                ...
                <div class="flex-1 min-w-0">
                  <p class="text-body font-semibold text-slate-800 leading-snug">
        ...
        <div v-if="editingMember !== null" class="mt-3 border border-slate-200 rounded-xl p-4 bg-white shadow-sm">
          <p class="text-body font-bold text-slate-700 mb-5">
          ...
          <div class="space-y-3 mt-2">
            ...
            <div class="flex gap-3">
              <!-- คำนำหน้า -->
              <div class="w-[35%]">
                <label class="text-body text-slate-600 mb-1.5 font-medium block">คำนำหน้า <span class="text-red-500">*</span></label>
                <select v-model="editingMember.prefixId"
                  class="w-full bg-white border rounded-xl px-3 py-2 text-body focus:outline-none focus:ring-2 transition-colors"
                ...
                <input v-if="editingMember.prefixId === 'none'"
                  ...
                  class="mt-1.5 w-full bg-white border border-slate-200 rounded-xl px-3 py-2 text-body focus:outline-none focus:ring-2 focus:ring-[#1A56DB]/30 focus:border-[#1A56DB]" />
              </div>
              <!-- ชื่อ -->
              <div class="flex-1">
                <label class="text-body text-slate-600 mb-1.5 font-medium block">ชื่อ <span class="text-red-500">*</span></label>
                <input
            ...
            <!-- นามสกุล -->
            <div>
              <label class="text-body text-slate-600 mb-1.5 font-medium block">นามสกุล <span class="text-red-500">*</span></label>
              <input
            ...
            <!-- เลขบัตรประชาชน -->
            <div>
              <label class="text-body text-slate-600 mb-1.5 font-medium block">เลขบัตรประชาชน</label>
              <input
            ...
            <div>
              <label class="text-body text-slate-600 mb-1.5 font-medium block">วัน/เดือน/ปีเกิด <span class="text-red-500">*</span></label>
              <div class="flex gap-2">
                <!-- วัน: แคบ -->
                <select
                  v-model="memberDobParts.day"
                  @change="handleDobPartChange"
                  class="w-[62px] shrink-0 bg-white border rounded-xl px-2 py-2.5 text-body focus:outline-none focus:ring-2 transition-colors"
                ...
                <select
                  ...
                  @change="handleDobPartChange"
                  class="flex-1 min-w-0 bg-white border rounded-xl px-3 py-2.5 text-body focus:outline-none focus:ring-2 transition-colors"
                  :class="editMemberErrors.dateOfBirth ? 'border-red-300 focus:ring-red-200' : 'border-slate-200 focus:ring-[#1A56DB]/30 focus:border-[#1A56DB]'">
                ...
                <select
                  ...
                  @change="handleDobPartChange"
                  class="w-[88px] shrink-0 bg-white border rounded-xl px-2 py-2.5 text-body focus:outline-none focus:ring-2 transition-colors"
                  :class="editMemberErrors.dateOfBirth ? 'border-red-300 focus:ring-red-200' : 'border-slate-200 focus:ring-[#1A56DB]/30 focus:border-[#1A56DB]'">
            ...
            <div class="grid grid-cols-2 gap-3">
              <!-- ความสัมพันธ์ -->
              <div>
                <label class="text-body text-slate-600 mb-1.5 font-medium block">ความสัมพันธ์กับผู้ประสบปัญหา <span class="text-red-500">*</span></label>
                <select
                  v-model="editingMember.relationToApplicantId"
                  class="w-full bg-white border rounded-xl px-3 py-2 text-body focus:outline-none focus:ring-2 transition-colors appearance-none"
              ...
              <!-- อาชีพ -->
              <div>
                <label class="text-body text-slate-600 mb-1.5 font-medium block">อาชีพ <span class="text-red-500">*</span></label>
              ...
              <!-- รายได้ต่อเดือน -->
              <div>
                <label class="text-body text-slate-600 mb-1.5 font-medium block">รายได้ต่อเดือน (บาท) <span class="text-red-500">*</span></label>
                <div class="relative">
                  <input
                    :value="displayIncome"
                    ...
                    placeholder="0"
                    class="w-full bg-white border rounded-xl px-3 py-2 pr-14 text-body focus:outline-none focus:ring-2 transition-colors"
              ...
              <!-- สภาพร่างกาย -->
              <div>
                <label class="text-body text-slate-600 mb-1.5 font-medium block">สภาพทางร่างกาย <span class="text-red-500">*</span></label>
            ...
            <div>
              <label class="text-body text-slate-600 mb-1.5 font-medium block">การช่วยเหลือตนเอง <span class="text-red-500">*</span></label>
              <div class="grid grid-cols-2 gap-2">
                ...
                <label
                  ...
                  <span class="text-body text-slate-700">ช่วยเหลือตนเองได้</span>
                </label>
                ...
                <label
                  ...
                  <span class="text-body text-slate-700">ช่วยเหลือตนเองไม่ได้</span>
                </label>
              </div>
